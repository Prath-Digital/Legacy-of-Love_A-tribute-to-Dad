...
const PASSWORD_HASH = '$2a$10$dbF.8npoPVvehRIjs0xZgO/tHCVRFlVMY6hOTy19L/0SqzpRIBvry';
...
export const verifyPassword = async (inputPassword: string): Promise<boolean> => {
  try {
    ...
    // Use synchronous compare from bcryptjs to return a boolean reliably
    return bcrypt.compareSync(inputPassword, PASSWORD_HASH);
  } catch (error) {
